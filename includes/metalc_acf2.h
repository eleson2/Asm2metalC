...
#define ACF2_RC_ALLOW          RC_OK     /* Allow access/continue         */
#define ACF2_RC_DENY           RC_WARNING  /* Deny access/reject            */
#define ACF2_RC_REVOKE         RC_ERROR    /* Revoke logonid (severe)       */
#define ACF2_RC_ABORT          RC_SEVERE   /* Abort processing              */

/* Password exit return codes */
#define ACF2_PWD_ACCEPT        RC_OK     /* Accept password               */
#define ACF2_PWD_REJECT        RC_WARNING  /* Reject password               */
#define ACF2_PWD_REVOKE        RC_ERROR    /* Revoke due to violation       */

/* Resource exit return codes */
#define ACF2_RES_CONTINUE      RC_OK     /* Continue normal processing    */
#define ACF2_RES_ALLOW         RC_WARNING  /* Override: allow access        */
#define ACF2_RES_DENY          RC_ERROR    /* Override: deny access         */
#define ACF2_RES_LOG           RC_SEVERE   /* Log only, continue            */
